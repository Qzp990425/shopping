		...
		<form action="/shopping/AdminBookServlet" method="post">
		  ...
		  <div class="form-row">
			<div class="form-group col-md-6">
			  ...
			  <input class="form-control" type="text" placeholder="书名" name="name">
			</div>
			<div class="form-group col-md-6">
			 <label for="inputName">书图片(形式:img/xxx.jpg)</label>
			 <input class="form-control" type="text" placeholder="图片名称" name="img">
			</div>
		  </div>
		  <div class="form-row">
		  	<div class="form-group col-md-12">
			  <label for="inputName">书的链接</label>
			  <input class="form-control" type="text" value="http://www.baidu.com" name="link">
			</div>
		  </div>
		  <div class="form-row">
			  <div class="form-group col-md-6">
			  ...
			  <div class="form-group col-md-6">
					...
					<input class="form-control" type="text" placeholder="库存" name="num">
			</div>
		</div>
		  <div class="form-row">
			...
			<div class="form-group col-xs-6 col-md-4" >
				  ...
				  <input class="form-control" type="text" placeholder="原价" name="price">
			</div>
			<div class="form-group col-xs-6 col-md-4">
				 <label for="price">现价</label>
				<input class="form-control" type="text" placeholder="现价" name="nowprice">
			</div>
		  </div>
		  <button type="submit" class="btn btn-primary" style="float:right;">加入</button>
		</form>
