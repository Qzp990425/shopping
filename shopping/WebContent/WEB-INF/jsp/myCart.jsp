	...
	<!-- 头部 -->					
		...
		<div class="container">
			 <div class="table-responsive m-t">
			 	<form id="cartform" action="/shopping/MyCartServlet" method="post">
					<table class="table invoice-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" name="buynum" class="form-control buynum"  aria-label="buynumber" aria-describedby="basic-addon1" style="width:50px;" value=<%= cart.getBuyNum()%>>
									<input type="hidden" class="hidbuynum" value=<%= cart.getBuyNum()%>>
									<input type="hidden" class="num" value=<%= cart.getNum()%>>
								</td>
								<td><%= cart.getNum() %></td>
								<td><%= cart.getPrice() %></td>
								<td><%= cart.getBuyNum()*cart.getPrice() %></td>								
								<td><a class="btn btn-primary" href='/shopping/MyCartServlet?operator=delete&bookid=<%=cart.getBookId() %>'>删除商品</a></td>
							</tr>
							<%	
							...
							%>
							<tr>
								<td><strong>总计</strong></td><td></td><td></td><td></td><td></td>
								<td>&yen;<%=total %></td>
							...
							<tr>
								...
								<td>
									<button class="btn btn-primary" name="operator" type="submit" value="update">修改</button>
								</td>
